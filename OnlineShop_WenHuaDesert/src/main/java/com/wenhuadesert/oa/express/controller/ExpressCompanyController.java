...
public class ExpressCompanyController {
	...
	public Result<String> add(ExpressCompanyModel em) throws Exception {
		ecs.add(em);
	...
	public Result<String> modify(ExpressCompanyModel em) throws Exception {
		ecs.modify(em);
		Result<String> result = new Result<String>();
		result.setStatus("ok");
	...
	public Result<String> delete(ExpressCompanyModel em) throws Exception{
		ecs.delete(em);
		Result<String> result=new Result<String>();
		result.setStatus("ok");
